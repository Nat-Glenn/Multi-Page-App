// app/home-page.tsx (or wherever your HomePage lives)
import { Ionicons, MaterialCommunityIcons } from '@expo/vector-icons';
import { useRouter } from 'expo-router';
import React from 'react';
import { StyleSheet, Text, TextInput, TouchableOpacity, View } from 'react-native';

const PHONE_MAX = 420; // cap width on web to look like a phone
    ...
    <View style={styles.screen}>
      <View style={styles.phone}>
        ...
        <View style={styles.bottomBar}>
          ...
          {/* center yellow — ignore touches so it doesn't block taps */}
...
const styles = StyleSheet.create({
  // outer frame centers content on web and gives the grey background
  screen: { flex: 1, backgroundColor: '#F3F6F8', alignItems: 'center' },
  // inner “phone” column that caps width
  ...
  appName: { marginTop: 55, color: '#fff', fontSize: 15, fontWeight: '300' },
  greeting: { color: '#fff', fontSize: 22, fontWeight: '300', marginTop: 2 },
  searchBar: {
    marginTop: 14,
    height: 44,
  ...
  searchInput: { marginLeft: 10, flex: 1, color: '#fff', fontSize: 15 },

  content: { flex: 1, paddingTop: 12, paddingBottom: 0 },
  ...
  actionText: { fontSize: 14, fontWeight: '500', color: '#1F2933' },
  ...
  sectionTitle: { fontSize: 16, fontWeight: '400', color: '#374957', paddingHorizontal: 14 },
  ...
  accountName: { fontSize: 15, color: '#374957' },
  accountRight: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  accountAmount: { fontSize: 15, fontWeight: '400', color: '#374957' },
  accountActionsRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  linkText: { color: '#0061B1', fontWeight: '500' },
  verticalDivider: { width: 1, height: 16, backgroundColor: '#D0D7DE' },

  alertRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 6, paddingVertical: 6 },
  alertTitle: { color: '#C1182D', fontWeight: '600', fontSize: 13 },
  alertSub: { color: '#697784', fontSize: 12 },
  ...
  centerWrapper: { position: 'absolute', alignSelf: 'center', top: -26 },
  centerButton: {
    width: 64,
    height: 64,
    borderRadius: 32,
